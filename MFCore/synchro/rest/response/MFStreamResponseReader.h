...
@interface MFStreamResponseReader : NSObject<MFRestResponseReaderProtocol>
...
@property (nonatomic, retain) MFJsonReader *jsonReader;
@property (nonatomic, retain) id response;

/*!
 * @brief ajoute un processeur de "noeud" à l'instance
 */
