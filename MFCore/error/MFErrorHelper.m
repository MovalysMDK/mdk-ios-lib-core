...
+(NSError *) initErrorWithDomain: (NSString *) domain andLocalizedDescriptionKey: (NSString *)localizedDescriptionKey andLocalizedFailureReasonErrorKey: (NSString *) localizedFailureReasonErrorKey{
    return [[NSError alloc] initWithDomain:domain
                                      code: 0
                                  userInfo:@{NSLocalizedDescriptionKey : MFLocalizedStringFromKey(localizedDescriptionKey),
...
+(NSError *) initErrorWithDomain: (NSString *) domain andLocalizedDescriptionKey: (NSString *)localizedDescriptionKey {
    return [MFErrorHelper initErrorWithDomain:domain andLocalizedDescriptionKey:localizedDescriptionKey andLocalizedFailureReasonErrorKey:localizedDescriptionKey];
}
