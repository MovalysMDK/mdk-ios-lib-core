...
@interface MFProjectCsvLoaderRunInit ()

@end

@implementation MFProjectCsvLoaderRunInit
...
-(void) startUsingContext:(id<MFContextProtocol>)mfContext firstLaunch:(BOOL)firstLaunch{
    ...
    if ( firstLaunch ) {
        MFCoreLogInfo(@"MFProjectCsvLoaderRunInit is launching");
