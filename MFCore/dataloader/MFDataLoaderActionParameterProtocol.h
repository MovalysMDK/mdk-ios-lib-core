 ...
 */
//
//  MFDataLoaderActionParameterProtocol.h
//  MFCore
//
//

@protocol MFDataLoaderActionParameterProtocol
...
-(NSString *) getDataLoaderClassName ;

-(void) setDataLoaderClassName:(NSString *) p_name ;
