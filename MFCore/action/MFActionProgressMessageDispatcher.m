 ...
 */
//
//  MFActionProgressMessageDispatcher.m
//  MFCore
//
//
...
-(void)dispatchProgressMessage:(NSString *)step withParam:(id)object andContext:(id<MFContextProtocol>) context {
    [[MFActionLauncher getInstance] notifyListenerOnProgressOfAction:self.actionName withStep:step withObject:object andCaller:self.caller andContext:context];
}
